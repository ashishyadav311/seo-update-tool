...
var _mysqlConfiguration = function() {
    return {
        ...
        multipleStatements: process.env.MYSQL_MYSQL_MULTIPLE_STATEMENTS
    };
}
...
db.connect = function() {
    ...
    var connection = mysql.createConnection(_mysqlConfiguration());
